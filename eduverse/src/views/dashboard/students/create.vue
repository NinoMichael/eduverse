...
import type { StudentFormData, Gender } from "@/types/student";
...
const handleSubmit = async () => {
	...
	if (success) {
		...
		toast.error(studentStore.error || "Erreur lors de la création");
	}
};
	...
	<div class="space-y-4 lg:space-y-6">
		...
		<div class="relative space-y-1 bg-primary text-white p-8 rounded-lg w-full">
			...
			<p class="text-sm w-[70%]">
				Remplissez les informations ci-dessous pour enregistrer un nouvel étudiant.
			</p>
